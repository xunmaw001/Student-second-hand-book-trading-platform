    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="书籍详情" prop="shujixiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shujixiangqing" label="书籍详情" prop="shujixiangqing">
                    <span v-html="ruleForm.shujixiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.shujixiangqing = this.ruleForm.shujixiangqing.replace(reg,'../../../ssmxm4f1/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
